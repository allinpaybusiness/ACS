...
class TLSWscoring_logistic(TLSWscoring):
    ...
    def logistic_bagging_trainandtest(self, cutscore, testsize, cv, feature_sel, varthreshold, nclusters, cmethod, resmethod, preprocess, label=None):
    ...
    def logistic_bagging_trainandtest_kfold(self, nsplit, cutscore, cv, feature_sel, varthreshold, nclusters, cmethod, resmethod, preprocess):
